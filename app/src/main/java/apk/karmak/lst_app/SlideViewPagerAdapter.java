...
//                picture.setImageResource(R.drawable.illus_one);
                ...
                ind1.setImageResource(R.drawable.sel);
                ind2.setImageResource(R.drawable.none);
                ind3.setImageResource(R.drawable.none);
...
//                picture.setImageResource(R.drawable.illus_two);
                ind1.setImageResource(R.drawable.none);
                ind2.setImageResource(R.drawable.sel);
                ind3.setImageResource(R.drawable.none);
...
//                picture.setImageResource(R.drawable.illus_three);
                ind1.setImageResource(R.drawable.none);
                ind2.setImageResource(R.drawable.none);
                ind3.setImageResource(R.drawable.sel);
